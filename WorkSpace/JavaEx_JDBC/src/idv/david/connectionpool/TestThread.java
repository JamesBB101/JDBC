...
public class TestThread extends SQLAgent implements Runnable {
	...
	public static void main(String argv[]) {
		...
		TestThread sr1 = new TestThread("SELECT * FROM EMP", connPool);
		TestThread sr2 = new TestThread("SELECT * FROM DEPT", connPool);
		TestThread sr3 = new TestThread("SELECT * FROM EMP", connPool);
		TestThread sr4 = new TestThread("SELECT * FROM DEPT", connPool);
